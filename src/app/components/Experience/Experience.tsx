  ...
  const cardData = [
    {
      ...
      description: "Designed for you, Black is the perfect solution for you and your teams tracking time.",
    ...
    },
    {
      ...
      description: "Available on iOS and Android, Black is accessible from any device.",
      paragraphClassName: "mainTexts",
      hasImageFirst: true,
    },
    {
    ...
    },
    {
      ...
      description: "Awarded App of the day, Black has been recognized as the top choice for teams and individuals.",
      paragraphClassName: "mainTexts",
      hasImageFirst: false,
    },
  ];
